// Bootstrap Tooltips (http://timforsythe.com/gigatrees)
$(document).ready(function () {
    ...
    $('[data-toggle="popover"]').popover({
		...
		template: '<div class="popover" role="tooltip" style="width: 500px;" onmouseover="$(this).mouseleave(function() {$(this).hide();});"><div class="arrow"></div><div class="popover-inner"><h3 class="popover-title"></h3></div></div>',
