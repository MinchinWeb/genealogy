...
function printComboChart(obj, bindingId, yearT, menT, menCountedT, womenT, womenCountedT, avgLifeSpanT, numCountedT) {
    ...
    var chart = c3.generate({
        ...
        data: {
            ...
            colors: {
                "Men" : '#268bd2',  // @sol-blue
                "Men Counted" : '#92C1DB',  // @sol-blue + @ sol-white
                "Women" : '#d33682',  // @sol-pink
                "Women Counted" : '#E896B3',  // @sol-pink + @ sol-white
            },
        },
        bar: {
            width: {
...
function printBoysNames(obj,rankT) {
    printBarChart(obj, 'boysNamesChartContainer', '268bd2', 15, 15, 'Open Sans', rankT);
}

function printGirlsNames(obj,rankT) {
    printBarChart(obj, 'girlsNamesChartContainer', 'd33682', 15, 15, 'Open Sans', rankT);
}

function printSurnames(obj,rankT) {
    printBarChart(obj, 'surnamesChartContainer', '6c71c4', 15, 15, 'Open Sans', rankT);
}
